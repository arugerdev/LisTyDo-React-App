...
export default function MainSpace({ id, handleCreateActivity, handleSaveActivityMods, handleRemoveActivity, handleChangeName, handleClickRemove, handleCreateColumn, branchs, handleChangeColumnName, handleClickRemoveColumn }) {
