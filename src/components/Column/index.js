...
export default function Column({ branchs, handleCreateActivity, handleSaveActivityMods, handleRemoveActivity, defaultName, branch_id, column_id, handleClickRemoveColumn, handleChangeColumnName, column }) {
            ...
            <div className="actvitys-parent">
                {currentColumn.activities.map((act, i) =>
                    <div className="draggeable-parent" >
                        <Activity key={act.id} handleSaveActivityMods={handleSaveActivityMods} branch_id={branch_id} column_id={column_id} activity_id={act.id} handleRemoveActivity={handleRemoveActivity} activity_data={act}></Activity>
                    </div>
                )
                }
